from minecraft.networking.authentication import _raise_from_request
from minecraft.networking.authentication import _make_request
from minecraft.networking.authentication import AuthenticationToken
...
class Yggdrasil(unittest.TestCase):
    ...
    def test_init_both(self):
        a = AuthenticationToken(access_token=FAKE_DATA["access_token"],  # noqa
                                client_token=FAKE_DATA["client_token"])  # noqa


class MakeRequest(unittest.TestCase):
    def test_make_request_http_method(self):
        req = _make_request("authenticate", {"Billy": "Bob"})
